...
export default function NavigationItem({ 
  ...
  return (
    <NavLink 
      to={to}
      className={({ isActive }) => 
        `flex items-center px-3 py-2 rounded-lg transition-all duration-300 hover:shadow-lg border border-transparent ${colorClasses.hover} ${
          isActive ? activeStyle + ' ' + colorClasses.active : 'text-white'
        }`
      }
      onClick={onClick}
      end={end}
